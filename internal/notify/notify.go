...
//   - CARRY-044 — GitHub identity ops@example.com is canonical
//
...
type Recipients struct {
	Primary string   // "ops@example.com"
...
func (d *Dispatcher) Send(ctx context.Context, m Email) error {
	...
	// v17607-6: enforce canonical recipient allowlist (ops@example.com only).
