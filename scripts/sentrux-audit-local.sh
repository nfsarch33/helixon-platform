...
if [ -f /home/user/Code/cursor-global-kb/adrs/ADR-0095-helixon-service-registry.md ] && [ -f /home/user/Code/cursor-global-kb/adrs/ADR-0096-host-d-recovery.md ]; then
