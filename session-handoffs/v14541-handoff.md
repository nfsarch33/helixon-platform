...
services=15
  alertmanager                   0.0.0.0     :9093   http  ts=100.64.0.1
  grafana                        0.0.0.0     :3000   http  ts=100.64.0.1
  k3s-server                     0.0.0.0     :6443   http  ts=100.64.0.1
  llama-server-c2-q4             0.0.0.0     :8011   http  ts=100.64.0.1
  llama-server-c7-q8             0.0.0.0     :8010   http  ts=100.64.0.1
  llm-cluster-router             0.0.0.0     :8787   http  ts=100.64.0.1
  ...
=== /metrics ===
...
Node     : node-a (fleet-host-a-node-a @ 100.64.0.1)
Creds    :
  - mem0-oss-admin-key (op_uri=op://<vault-name>/mem0-oss-admin-key)
  - mem0-oss-jwt-secret (op_uri=op://<vault-name>/mem0-oss-jwt-secret)
```

`helix-dev-tools services health --node node-a` (live HTTP probes):
