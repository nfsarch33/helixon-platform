...
Stub Alertmanager (`/mnt/c/Users/jaslian.FLEET-HOST-A/AppData/Local/Temp/ack-drill-stub.py`)
...
> Continue with v14514 Pair 6 MVP: restore all MCP servers on host-a +
> node-a; smoke test each; cursor-tools CLI; TDD test_mcp_health.py.
