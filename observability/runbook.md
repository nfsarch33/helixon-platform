...
| --- | --- | --- |
| 1 | `bash /home/user/Code/helixon-platform/scripts/agentcage/install-tier4-verify.sh` | PASS ≥ 53 |
| 2 | `/tmp/choose-llm matrix list --matrix /home/user/Code/cursor-global-kb/scripts/fleet/qwen36-matrix.yaml` | non-empty ready cells |
