...
|----|----|----|
| `HELIXON_LLM_KEY` | `op://<vault-name>/helixon-llm-key/credential` | LLM provider auth |
| `HELIXON_MEMORY_KEY` | `op://<vault-name>/helixon-memory-key/credential` | Engram memory L1 |
