...
func resolvePromptsPath(t *testing.T) string {
	...
	candidates := []string{
		...
		filepath.Join(cwd, "..", "eval-harness", "prompts-10.json"),
		"/home/user/Code/helixon-platform/eval-harness/prompts-10.json",
		"/mnt/c/Users/jaslian.FLEET-HOST-A/Code/helixon-platform/eval-harness/prompts-10.json",
	}
...
func TestSmoke_BlockedMatrixFailsCleanly(t *testing.T) {
	...
	require.NoError(t, os.WriteFile(p, []byte(
		"schema_version: 1\ncells:\n  X: {node: node-a, gpu_class: rtx2070, gpu_slot: gpu0, model_id: blocked, repo: r/r, revision: main, file: m, expected_bytes: 0, status: metadata_blocked, engine: llama.cpp, host_port: 8001, max_model_len: 8192, min_free_mib: 1536, local_path: /tmp/m}\n",
	), 0o644))
