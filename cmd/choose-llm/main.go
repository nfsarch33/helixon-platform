...
func newHookInstallCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&flags, "flags", "hook decide --matrix /home/user/Code/cursor-global-kb/scripts/fleet/qwen36-matrix.yaml", "flag line passed to choose-llm hook decide")
	return cmd
}
...
func defaultMatrixPath() string {
	...
	for _, root := range []string{
		"/home/user/Code/cursor-global-kb",
		"/home/user/Code/helixon-platform",
		"/mnt/c/Users/jaslian.FLEET-HOST-A/Code/cursor-global-kb",
	} {
	...
	return "/home/user/Code/cursor-global-kb/scripts/fleet/qwen36-matrix.yaml"
}
